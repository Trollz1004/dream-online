...
Use Gameplay Ability System for abilities, attributes, gameplay tags, costs, cooldowns, effects, and replication. Use C++ for per-frame combat traces, movement, prediction-critical logic, and hit validation. Use Blueprint only for designer-facing ability tuning and animation hooks.
